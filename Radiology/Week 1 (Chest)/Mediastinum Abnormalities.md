...
- Anatomist Approach
	- Superior: Transverse manubriosternal joint and T4 vertebra
	- Inferior:
		- Anterior: Sternum <-> middle
		- Middle: Pericardium, major vessels, and airways
		- Posterior: Middle <-> thoracic vertebrae

- Felson Method
	- Anterior: Sternum and heart <-> anterior to trachea
	- Middle: Trachea <-> 1cm behind anterior to thoracic vertebrae
...
- Divisions of mediastinum are theoretic versus physical, so disease can still spread

___ 
**Anterior Mediastinum**
- Bounds
	- Anterior: Sternum
	- Posterior: Pericardium, aorta, and brachiocephalic vessels
